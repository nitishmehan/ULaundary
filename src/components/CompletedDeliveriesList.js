...
export default function CompletedDeliveriesList({ deliveries }) {
        ...
        <div className="space-y-6">
          ...
          <div className="p-6 bg-white/5 border border-white/10 rounded-xl">
            <div className="flex justify-between items-center mb-4">
              <h4 className="text-lg font-semibold text-white">Items Delivered</h4>
          ...
          <div className="p-6 bg-white/5 border border-white/10 rounded-xl">
            <div className="flex justify-between">
              <div>
                ...
                <span className="inline-block px-3 py-1 bg-green-500/20 text-green-300 rounded-full text-xs font-semibold mt-1">
                  DELIVERED
                </span>
              </div>
              <div className="text-right">
                <p className="text-gray-400 text-sm">Delivered On</p>
                <p className="text-white mt-1">{formatDate(viewingDelivery.deliveredAt)}</p>
              </div>
            </div>
          </div>
      ...
      <table className="w-full">
        <thead>
          <tr className="border-b border-white/10">
            ...
            <th className="text-center py-4 px-4 text-gray-400 font-medium">Delivered</th>
