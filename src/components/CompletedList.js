...
export default function CompletedList({ requests }) {
          ...
          <div className="p-6 bg-white/5 border border-white/10 rounded-xl">
            <div className="flex justify-between">
              ...
              <div className="text-right">
                ...
                <p className="text-white mt-1">{formatDate(viewingRequest.washingCompletedAt)}</p>
              </div>
            </div>
          </div>
            ...
            requests.map((request) => (
              <tr key={request.id} className="border-b border-white/5 hover:bg-white/5">
                ...
                <td className="py-4 px-4 text-center text-gray-400 text-sm">
                  {formatDate(request.washingCompletedAt)}
                </td>
                <td className="py-4 px-4 text-center">
                  <button
